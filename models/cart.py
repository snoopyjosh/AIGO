    ...
    def display(self):  #
        ...
        for product_name, num in self.bucket().items():
            ...
            product_box_component.append(
                BoxComponent(
                    ...
                    contents=[
                        TextComponent(
                            text="{num} x {product}".format(
                                num=num, product=product_name
                            ),
                            size="sm",
                            color="#555555",
                            flex=0,
        ...
        bubble = BubbleContainer(
            ...
            body=BoxComponent(
                layout="vertical",
                contents=[
                    TextComponent(text="Here is your order.", wrap=True, size="md"),
                    ...
                    BoxComponent(
                        ...
                        contents=[
                            BoxComponent(
                                ...
                                contents=[
                                    TextComponent(
                                        text="TOTAL", size="sm", color="#555555", flex=0
                                    ),
                                    TextComponent(
                                        text="NT$ {total}".format(total=total),
                                        size="sm",
                                        color="#111111",
                                        align="end",
                                    ),
                        ...
                        contents=[
                            ButtonComponent(
                                ...
                                action=MessageAction(
                                    label="Empty Cart", text="Empty cart"
                                ),
                            ),
                            ButtonComponent(
                                style="primary",
                                color="#aaaaaa",
                                flex=2,
                                action=MessageAction(label="Add", text="add"),
                            ),
                        ],
                    ),
                ],
