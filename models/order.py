...
class Orders(Base):
    ...
    )  # ForeignKey外來鍵的意思，訂單是由哪一個user建立的
            ...
            item_box_component.append(
                BoxComponent(
                    ...
                    contents=[  # 透過TextComponent顯示明細資料 text='{quantity} x {product_name}數量/產品名稱
                        TextComponent(
                            text="{quantity} x {product_name}".format(
        ...
        bubble = BubbleContainer(
            ...
            body=BoxComponent(
                ...
                contents=[
                    ...
                    TextComponent(
                        text="LSTORE", weight="bold", size="xxl", margin="md"
                    ),
                    TextComponent(
                        text="Online Store", size="xs", color="#aaaaaa", wrap=True
                    ),
                        ...
                        contents=[
                            BoxComponent(
                                ...
                                contents=[  # 顯示總金額
                                    ...
                                    TextComponent(
                                        text="NT${total}".format(total=self.amount),
                                        size="sm",
                                        color="#111111",
                                        align="end",
                                    ),
